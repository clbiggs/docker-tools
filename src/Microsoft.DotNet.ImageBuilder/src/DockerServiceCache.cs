...
namespace Microsoft.DotNet.ImageBuilder
{
    ...
    internal class DockerServiceCache : IDockerService
    {
        ...
        public string? BuildImage(
            ...
            IDictionary<string, string?> buildArgs, bool isRetryEnabled, bool isDryRun, bool noLayerCache) =>
            _inner.BuildImage(dockerfilePath, buildContextPath, platform, tags, buildArgs, isRetryEnabled, isDryRun, noLayerCache);
